...
public class InspectorHelper
{
    ...
    {
        trafficHeadquarter.arrowDrawTpye = (TrafficHeadquarter.ArrowDraw)
            EditorGUILayout.EnumPopup("화살표 타입", trafficHeadquarter.arrowDrawTpye);
        EditorGUI.indentLevel++;

        switch (trafficHeadquarter.arrowDrawTpye)
        {
        ...
        if (trafficHeadquarter.arrowDrawTpye != TrafficHeadquarter.ArrowDraw.Off)
        {
